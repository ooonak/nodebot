...
void nb::SlashCommandController::start(dpp::snowflake &guildId)
{
  if (!mInitialized)
  {
    ...
    dpp::slashcommand command("cmd", "Send a command", mBot->me.id);
    ...
    const dpp::slashcommand_t &event)
{
  ...
  if (event.command.get_command_name() == "cmd")
  {
